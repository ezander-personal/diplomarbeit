...
\eqnl[svdkomp]{\vec c_i = \sum_{k=1}^N \frac{1}{\sigma_i} s_{ik} \x_k} 
...
\comment{
\eqn{\vec y_j=\left( \begin{array}{c} \x_j \vec c_1 \\ \x_j \vec c_2 \\ \vdots \\ \x_j \vec c_\embed
\end{array} \right)}}
